# Operator Quickstart — Vineyard Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0121** (`cloud-itonami-isic-0121`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0121.git
cd cloud-itonami-isic-0121
```
...
- Blueprint governor key: `vineyard-operations-governor`
- Likely source path: `vineyardops.governor.cljc`
