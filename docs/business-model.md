# Business Model: Vineyard Operations Coordinator

## Classification

- Repository: `cloud-itonami-isic-0121`
- ISIC Rev. 4: `0121`
...
- Small-to-medium wine-grape growers
- Table-grape and raisin-grape operations
- Vineyard management companies
- Cooperative wineries needing grower-side records

## Offer

- Vineyard/block record-keeping (planting, harvest, yield, brix testing)
...
- Vineyard/block registration is required before any operation
...
- Flag suspected pest pressure (e.g. phylloxera)
- Report disease or frost-damage observations
