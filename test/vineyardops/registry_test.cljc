...
(deftest vineyard-count-non-positive-test
  (testing "Positive count is valid"
    (is (false? (registry/vineyard-count-non-positive? 500))))

  (testing "Zero count is invalid"
    (is (true? (registry/vineyard-count-non-positive? 0))))

  (testing "Negative count is invalid"
    (is (true? (registry/vineyard-count-non-positive? -5)))))
